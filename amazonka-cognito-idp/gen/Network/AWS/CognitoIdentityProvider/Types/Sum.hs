...
instance FromText UserStatusType where
  parser = takeLowerText >>= \case
    ...
    "external_provider" -> pure ExternalProvider
    "unknown" -> pure Unknown
    e ->
      fromTextError $
        "Failure parsing UserStatusType from value: '" <> e
          <> "'. Accepted values: archived, compromised, confirmed, force_change_password, reset_required, unconfirmed, external_provider, unknown"
